...
public class PlayAudioSheet extends RoundedBottomSheetDialogFragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MaterialButton deleteRecording = view.findViewById(R.id.delete_recording);
        MaterialButton infoRecording = view.findViewById(R.id.info_recording);

        if (AppData.getAppData().isDarkerMode) {
            view.setBackgroundColor(getContext().getColor(R.color.darker_mode));
            deleteRecording.setBackgroundColor(getContext().getColor(R.color.not_too_dark_gray));
        ...
        deleteRecording.setOnClickListener(view14 -> {
