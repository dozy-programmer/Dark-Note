...
//  }
    ...
    public RichEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        addJavascriptInterface(new RichEditorInterface(this), "DarkNote");
        setWebChromeClient(new WebChromeClient() {
            @Override
            public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
                Log.d("Here", consoleMessage.message() + " -- From line "
    ...
    public void setImagePath(String imagePath, String html, int width, int height) {
        if (mImageClickListener != null) {
            mImageClickListener.onImageClick(imagePath, html, width, height);
        }
    }
